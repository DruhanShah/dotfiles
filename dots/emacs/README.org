...
As it turns out, there are a lot of convenient functions that I can do with in general. This config also requires them occasionally.

#+begin_src emacs-lisp
  (defun add-multiple-to-list (dst src)
    "Merge content of SRC into DST."
    (set dst
         (append (eval dst) src)))
#+end_src
  ...
  (defun mode-line-component-title ()
    ...
    (let* ((filename (buffer-name))
  	 (filename (cond
  		    ...
  		    (t filename)))
  	 (icon (cond
  		((eq major-mode 'ready-player-major-mode) (nerd-icons-mdicon "nf-md-music_circle"))
...
#+begin_src emacs-lisp
  (defun drs-mode-line-format-default ()
    ...
    '((:eval (mode-line-render
  	    ...
  	    (list (mode-line-component-position)
  		  (mode-line-padding))))))
...
Apparently every configuration language and its mother has a major-mode and LSP plugin these days.
I'm considering the treesitter grammar, but I'm leaving this section for the LSP server just in case.
