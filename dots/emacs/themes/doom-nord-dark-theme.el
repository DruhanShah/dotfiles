;;; doom-nord-dark-theme.el --- dark variant of Nord -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-nord-dark-theme nil
  "Options for the `doom-nord-dark' theme."
  :group 'doom-themes)

(defcustom doom-nord-dark-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-nord-dark-theme
  :type 'boolean)

(defcustom doom-nord-dark-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-nord-dark-theme
  :type 'boolean)

(defcustom doom-nord-dark-comment-bg doom-nord-dark-brighter-comments
  "If non-nil, comments will have a subtle, darker background, enhancing their legibility."
  :group 'doom-nord-dark-theme
  :type 'boolean)

(defcustom doom-nord-dark-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.  Can be an integer to determine the exact padding."
  :group 'doom-nord-dark-theme
  :type '(choice integer boolean))

(eval-and-compile
  (defcustom doom-nord-dark-region-highlight t
...
(def-doom-theme doom-nord-dark
  "A dark theme inspired by Nord."
  :family 'doom-nord-dark
  ...
  ((bg         '("#2E3440" nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        blue)
   (comments       (if doom-nord-dark-brighter-comments dark-cyan (doom-lighten base5 0.2)))
   (doc-comments   (doom-lighten (if doom-nord-dark-brighter-comments dark-cyan base5) 0.25))
   (constants      blue)
   (functions      cyan)
   (keywords       blue)
   (methods        cyan)
   ...
   (variables      base7)
   (numbers        magenta)
   (region         (pcase doom-nord-dark-region-highlight
                     (`frost teal)
                     (`snowstorm base7)
                     (_ base4)))
   (error          red)
   ...
   (-modeline-bright doom-nord-dark-brighter-modeline)
   (-modeline-pad
    (when doom-nord-dark-padded-modeline
      (if (integerp doom-nord-dark-padded-modeline) doom-nord-dark-padded-modeline 4)))

   (region-fg
    (when (memq doom-nord-dark-region-highlight '(frost snowstorm))
      base0))
...
;;; doom-nord-dark-theme.el ends here
