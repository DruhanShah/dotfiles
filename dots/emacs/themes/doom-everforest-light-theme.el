...
(def-doom-theme doom-everforest-light
  ...
  ((bg         `(,efl/bg         nil       nil            ))
   ...
   (fg         '("#3c4952" "#bfbfbf" "brightwhite"        ))
   (fg-alt     '("#5c6a72" "#2d2d2d" "white"              )) ;; bg5 dark soft
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (org-document-title :foreground fg-alt :weight 'bold :height 1.6)
   (org-block-begin-line :foreground dark-cyan
                         :background base1)
   (org-block-end-line :foreground dark-cyan
                         :background base1)
   (org-block :foreground fg :background base1)
   ...
   (org-level-4 :foreground fg :weight 'semi-bold)
   (org-level-5 :foreground fg :weight 'semi-bold)
   (org-level-6 :foreground fg :weight 'semi-bold)
   (org-level-7 :foreground fg :weight 'semi-bold)
