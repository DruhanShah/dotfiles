...
def _core(i):
    return popup.PopupText(
        ...
        bar_size=10,
        marker_size=0,
        colour_below=Colors.sky,
        colour_above=Colors.surface2,
...
battery_components = [
    ...
    popup.PopupCircularProgress(
        ...
        start_angle=180,
        marker_size=0,
        marker_colour=Colors.text,
        colour_below=Colors.green,
        colour_above=Colors.surface2,
        bar_border_colour=Colors.text,
        pos_x=55,
        pos_y=55,
...
calendar_components = [
    ...
    popup.PopupText(
        name=f"day_{i}_{ii}",
        foreground=Colors.text,
        background=Colors.crust if ii == 6 else Colors.mantle,
        fontsize=18,
        font=Fonts.sans + " Medium",
        markup=True,
        width=50,
    ...
    popup.PopupText(
        name=f"weekday_{i}",
        foreground=Colors.text,
        background=Colors.crust if i == 6 else Colors.mantle,
        fontsize=18,
        font=Fonts.sans + " Medium",
        markup=True,
        width=50,
