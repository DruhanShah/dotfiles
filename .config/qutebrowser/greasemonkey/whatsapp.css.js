...
.dark {
	...
	/* startup progress */
	--progress-primary: var(--accent-color) !important;
	...
	--intro-border: var(--accent-color) !important;
	/* general background */
	...
	--butterbar-update-icon: var(--accent-color) !important;
	...
	--icon-search-back: var(--accent-color) !important;
	/* archive icon */
	--icon-bright-highlight: var(--accent-color) !important;
	/* archived unread marker */
	--unread-marker-background: var(--accent-color) !important;
	--unread-timestamp: var(--accent-color) !important;
	...
	/* pinned chat icon */
	--icon-pinned: var(--accent-color) !important;
	...
	--incoming-background: var(--surface0) !important;
	...
	--incoming-background-rgb: var(--surface0);
	...
	--incoming-background-deeper: var(--surface1) !important;
	...
	--photopicker-overlay-background-rgb: var(--base) !important;
	--media-viewer-background-rgb: var(--base) !important;
	...
	/* mute toggle */
	--switch-button-checked-color: var(--accent-color) !important;
	...
	--active-tab-marker: var(--accent-color) !important;
	...
	--media-editor-thumb-border-active: var(--accent-color) !important;
	/* send button in media editor */
	--button-round-background: var(--accent-color) !important;
	...
	/*
	--panel-background-rgb: #rgbify(var(--mantle)) [];
	*/
	--checkbox-background: var(--accent-color) !important;
	...
	/* compose bar icons */
	--icon: var(--accent-color) !important;
	/* ATTACH ICONS */
	/* poll icon */
	div._1OT67
	> div
	...
	--ptt-draft-button-send: var(--accent-color) !important;
	...
	--button-primary-background: var(--accent-color) !important;
	--button-primary-background-hover: fadeout(var(--accent-color), 0.8) !important;
	/* keyboard shortcuts background */
	--panel-background-lighter: var(--mantle) !important;
	/* active input in modals and drawers */
	--input-border-active: var(--accent-color) !important;
}
