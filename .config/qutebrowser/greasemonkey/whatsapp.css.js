...
// ==/UserScript==
GM_addStyle(`@-moz-document domain("web.whatsapp.com") {
  body {
    color-scheme: dark;
    /* STATUS PAGE */
    ...
    /* startup progress */
    --progress-primary: #40a02b !important;
    ...
    --filters-container-background: #eff1f5 !important;
    /* filters item background */
    --filters-item-background: #ccd0da !important;
    /* filters item color */
    --filters-item-color: #6c6f85 !important;
    /* filters item background hover */
    --filters-item-background-hover: #bcc0cc !important;
    /* filters item active background */
    --filters-item-active-background: rgba(64, 160, 43, 0.3) !important;
    /* filters item active color */
    --filters-item-active-color: #40a02b !important;
    ...
    --butterbar-update-icon: #40a02b !important;
    ...
    --icon-search-back: #40a02b !important;
    /* archive icon */
    --icon-bright-highlight: #40a02b !important;
    /* archived unread marker */
    --unread-marker-background: #40a02b !important;
    --unread-timestamp: #40a02b !important;
    ...
    /* mute toggle */
    --switch-button-checked-color: #40a02b !important;
    ...
    --active-tab-marker: #40a02b !important;
    /* REACTIONS */
    ...
    --media-editor-thumb-border-active: #40a02b !important;
    /* send button in media editor */
    --button-round-background: #40a02b !important;
    /* COMPOSE BAR */
    ...
    --checkbox-background: #40a02b !important;
    ...
    --ptt-draft-button-send: #40a02b !important;
    ...
    --button-primary-background: #40a02b !important;
    --button-primary-background-hover: rgba(64, 160, 43, 0.992) !important;
    /* keyboard shortcuts background */
    --panel-background-lighter: #e6e9ef !important;
    /* active input in modals and drawers */
    --input-border-active: #40a02b !important;
    /* Start page drawing */
    /* Status unread dot */
  }
  body ::selection {
  ...
  body.dark {
    ...
    /* startup progress */
    --progress-primary: #a6e3a1 !important;
    ...
    /* filters item active background */
    --filters-item-active-background: rgba(166, 227, 161, 0.3) !important;
    /* filters item active color */
    --filters-item-active-color: #a6e3a1 !important;
    /* chat list background */
    ...
    --butterbar-update-icon: #a6e3a1 !important;
    /* chat list search bar */
    ...
    --icon-search-back: #a6e3a1 !important;
    /* archive icon */
    --icon-bright-highlight: #a6e3a1 !important;
    /* archived unread marker */
    --unread-marker-background: #a6e3a1 !important;
    --unread-timestamp: #a6e3a1 !important;
    /* archived chats header */
    ...
    /* mute toggle */
    --switch-button-checked-color: #a6e3a1 !important;
    ...
    --active-tab-marker: #a6e3a1 !important;
    /* REACTIONS */
    ...
    /* selected picture in media editor */
    --media-editor-thumb-border-active: #a6e3a1 !important;
    /* send button in media editor */
    --button-round-background: #a6e3a1 !important;
    /* COMPOSE BAR */
    /* type a message bar and background */
    ...
    --checkbox-background: #a6e3a1 !important;
    /* quoted message in compose */
    ...
    /* contact icon */
    /* VOICE MESSAGE SENDING */
    --ptt-draft-button-send: #a6e3a1 !important;
    ...
    /* buttons such as create community */
    --button-primary-background: #a6e3a1 !important;
    --button-primary-background-hover: rgba(166, 227, 161, 0.992) !important;
    /* keyboard shortcuts background */
    --panel-background-lighter: #181825 !important;
    /* active input in modals and drawers */
    --input-border-active: #a6e3a1 !important;
    /* Start page drawing */
    /* Status unread dot */
  }
  body.dark ::selection {
