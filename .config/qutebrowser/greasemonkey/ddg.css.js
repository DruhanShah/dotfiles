...
:root:not(.dark-bg) .module--translations-original textarea::placeholder {
    color: #5c5f77;
}
...
:root:not(.dark-bg) .module__items-precip-label__icon {
    ...
    background: url("data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2210%22%20height%3D%2210%22%20viewBox%3D%220%200%2010%2010%22%20fill%3D%22none%22%3E%3Cpath%20d%3D%22M8.339%204.317%205.487%200%202.65%204.307a3.67%203.67%200%200%200%20.533%204.784%203.434%203.434%200%200%200%204.645.01%203.66%203.66%200%200%200%20.513-4.78z%22%20fill%3D%22%231e66f5%22/%3E%3C/svg%3E") no-repeat !important;
}
...
:root:not(.dark-bg) .metabar__dropdowns-wrap::after {
    background-image: linear-gradient(90deg, #ccd0da, rgba(255, 255, 255, 0));
}
...
:root.dark-bg .module--translations-original textarea::placeholder {
    color: #bac2de;
}
...
:root.dark-bg .module__items-precip-label__icon {
    ...
    padding-left: 10px !important;
    padding-top: 10px !important;
    background: url("data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2210%22%20height%3D%2210%22%20viewBox%3D%220%200%2010%2010%22%20fill%3D%22none%22%3E%3Cpath%20d%3D%22M8.339%204.317%205.487%200%202.65%204.307a3.67%203.67%200%200%200%20.533%204.784%203.434%203.434%200%200%200%204.645.01%203.66%203.66%200%200%200%20.513-4.78z%22%20fill%3D%22%2389b4fa%22/%3E%3C/svg%3E") no-repeat !important;
}
...
:root.dark-bg .metabar__dropdowns-wrap::after {
    background-image: linear-gradient(90deg, #313244, rgba(255, 255, 255, 0));
}
