...
The next bit is all about minad (Daniel Mendler)'s package =org-modern=. I was earlier using the modified source code of the package as =nano-org= thinking I could nano-ify the whole thing, but in hindsight it was far more sensible to just customize some variables.
